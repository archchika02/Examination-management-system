...
const Register = () => {
    ...
    const handleChange = (e) => {
        ...
        setFormData(prev => {
            ...
            if (name === 'email') {
                if (value.endsWith('@stu.kln.ac.lk') || value === 'lihij13980@gamening.com' || value === 'hemoyev878@gamening.com' || value === 'wixal14117@creteanu.com' || value === 'mawik46348@cslua.com') {
                    setAvailableRoles(['Student', 'BatchRepresentative']);
                    if (!['Student', 'BatchRepresentative'].includes(newData.role)) {
                        newData.role = 'Student';
                    }
                } else if (value.endsWith('@kln.ac.lk') || value === 'archchika27@gmail.com' || value === 'bagivi1341@gxuzi.com' || value === 'wevaw72949@gxuzi.com' || value === 'yihobat906@gxuzi.com' || value === 'nacow76709@gxuzi.com' || value === 'wevaw72949@gxuzi.com' || value === 'thavashikalaxi@gmail.com' || value === 'archchika.t@gmail.com' || value === 'yibiko1642@cslua.com') {
    ...
    const handleSubmit = async (e) => {
        ...
        if (formData.role === 'Student' || formData.role === 'BatchRepresentative') {
            if (!formData.email.endsWith('@stu.kln.ac.lk') && formData.email !== 'archchika27@gmail.com' && formData.email !== 'lihij13980@gamening.com' && formData.email !== 'hemoyev878@gamening.com' && formData.email !== 'wixal14117@creteanu.com' && formData.email !== 'mawik46348@cslua.com') {
                setError('Student/BatchRepresentative must use @stu.kln.ac.lk email');
                return;
            }
        } else {
            if (!formData.email.endsWith('@kln.ac.lk') && formData.email !== 'archchika27@gmail.com' && formData.email !== 'bagivi1341@gxuzi.com' && formData.email !== 'wevaw72949@gxuzi.com' && formData.email !== 'yihobat906@gxuzi.com' && formData.email !== 'nacow76709@gxuzi.com' && formData.email !== 'wevaw72949@gxuzi.com' && formData.email !== 'thavashikalaxi@gmail.com' && formData.email !== 'archchika.t@gmail.com' && formData.email !== 'yibiko1642@cslua.com') {
